...
[`01:30`](http://www.youtube.com/watch?v=AFpeWo1GTeg&t=90) **90 年代游戏行业的启发**

* Demis 年轻时曾涉足游戏行业（90 年代），因为当时游戏行业是尖端技术的试验田（如图形学引擎和早期的 GPU）。
* **示例：主题公园 (Theme Park) 游戏**
* **细节**：他 17 岁时参与制作了著名的模拟游戏《主题公园》。该游戏模拟了游乐园，包含成千上万的小人（游客），他们有自己的经济 AI 模型，决定买什么、玩什么。
...
* **洞见**：如果技术太超前（领先 50 年），就无法取得商业上的成功；如果每个人都觉得明显，那又太迟了。这构成了他日后把握创新时机的重要哲学。

## DeepMind 的创立与 AGI 愿景

[`04:44`](http://www.youtube.com/watch?v=AFpeWo1GTeg&t=284) **2009 年创立 DeepMind**

* 2009 年，在"AGI（通用人工智能）"概念还被视为科幻时，Demis 开始着手准备。
* **吸引顶尖人才的原因（当时的四大核心要素）**：
...
* **预测 AGI 到来的年份**：2030 年（他表示自己对这个年份一直保持一致的态度）。
...
2. **5 年创新法则**：在科技创业中，产品的理念需要比时代领先 5 年，如果领先 50 年则无法实现商业成功。
