...
（但是，我确实逐渐积累了很多很多不愿意删除的skill，所以可以搭建一个skill编排层，我这里比较推荐这个：[GitHub - foryourhealth111-pixel/Vibe-Skills](https://github.com/foryourhealth111-pixel/Vibe-Skills)，可以自由添加skill并入编排层）
