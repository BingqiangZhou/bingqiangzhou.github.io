...
访谈里建议类的内容很密集，散在十一个观点中，这里按受众抽出来集中列一份（均为曾鸣原话的提炼，括号内对应上文小节）。

### 给创业者的

**先看清位置再动手**

- 做大模型（基础设施）的窗口已经关闭，智能飞轮已经转起来，此时进场完全没有积累；现在该做的是第二阶段的事——应用大爆发，「智能体就是 AI 时代的新应用」，第二阶段还有三到五年非常精彩的时间（第一节）。
- 大部分人**低估了 Agent 的难度**。去年拿 ARR 考核的「过家家」已被模型能力淹没；今年「智能真的能干活了、可以信赖了，开始想严肃地拿它干重要的活」——这才是应用阶段开始的真实标志（第五节）。
- Agent 公司不需要训传统意义上的模型：模型竞争会让智能成为大宗商品，「稳定调用，有合理的替代品随时能接上」；Cursor 那种试模型边界的做法会被 fold 进模型迭代里（第五节）。

**找方向的方法**

- 找一个足够大、足够复杂、足够有价值的场景，让 Agent **独立闭环干活**——真实世界反馈是「智能复利」飞轮的前提，撞上最能规模化、最能泛化的场景才可能形成黑洞效应（第五节）。
- 别追趋势：「别人已经领跑两步了，你只看见他冒出水面的第三步。你追肯定第一天就是输掉的。」（第八节）
- 警惕 ARR 幻觉。他的诊断三问：「继续涨两年以后又怎么样？产业终局会怎样？天花板多快会来？」——ARR 是拿当下外推 12 个月的线性幻觉，而且竞争一多，定价就从按客户价值变成**按边际成本**（第八节）。
- 现在的应用冰点是「反共识阶段」，他的安慰是：「找到自己发展的方向，认真做好自己的事情就好。做一件全新的事情，早期就是会比较困难。」（第五节）

**战略与组织**

- 「看十年、想三年、干一年」的关键在**看三年**：至少看三步，让短中长期形成张力；越不确定越需要战略思考——淘汰赛以几个月计，做错一个决定就出局（第八节）。
- 从「战略规划」转向「战略生成」：建一套让战略洞察涌现的环境（给足 context 而非 control），本质是人和 AI 一起训练一个组织的小模型（第六、八节）。
- 创业者要过的一关：优秀≠卓越。卓越是事后认定的，来自反共识加穿越一次次负反馈，「利他、同理心和自我逐渐变小」是必要条件。检验自己的第一问：「十年以后，你会对怎样的自己满意？」——回答「我要做一家百亿美金的公司」是负分答案（第七节）。
- 招人是感召来的，CEO 不能有老板心态（「我都不陪老登玩了，我还陪你老板玩？」）（第六节）。

### 给个人的

- **方向只有一个：开发创造力**。所有可被结构化处理的知识型工作都会被 AI 接管，人与人的差异在「无中生有」的能力——原创地定义复杂问题，而不只是会写歌画画（第十一节）。
- **经验贬值是结构性的**：能转化成知识的经验都被大模型吸收了（AI 已到主任医生水平），年轻人用 AI 杠杆能瞬间成为领域专家。他的半开玩笑版答案：「或者安心养老，或者变得重新年轻。」（第六节）
- **向内找驱动力**：未来靠自驱（high agency），没有层级给你爬了。具体四步：向内看找驱动力 → 明白要培养什么能力 → 找到这个能力最适合的场景跟着一起成长 → 交付透明，贡献自然会被定价（顶级研究员转会费高就是因为贡献透明）（第六节）。
- **工作形态会变**：岗位和层级消失，组织的基本单元变成任务——「你去认领任务，能干就接，交付结果就上线」；你的竞争对象不只是人类同事，还包括 AI 同事（第六节）。
- **心态上拥抱不确定性**：从降低不确定性转向「不确定性就是最大的机会」；见到复杂性就恐惧就没法往前走，觉得「特别好玩、有机会创造新东西」才是这一代创业者该有的心态（第十一节）。
- 教育一定被重塑：别把自己（和孩子）按在旧世界的固定模式里，顺着开放探索的路径开发潜能（第十一节）。

浓缩成一句给两类人共用的话，他自己给的那个「关键 bet」最合适：**未来两三年最值得押注的变量，是「出现一个足够好用的 to C Agent」**——创业者盯住它是机会，个人用好它是杠杆。
